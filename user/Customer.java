...
class Customer {
    ...
    public Customer(String customerName, String email, String phone, String address, String password, String cartDescription) {
        this.customerName = customerName;
        this.email = email;
        this.phone = phone;
        this.address = address;
        this.password = password;
        this.cart = new Cart(cartDescription);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (email != null && email.equals(other.email)) return true;
        if (phone != null && phone.equals(other.phone)) return true;
